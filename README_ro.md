...
•	Cloudflare blocking → Parabank returna HTML în loc de XML.  Soluție: adăugarea unui User-Agent valid (Edge/Chrome).
...
•	Raportul este disponibil public: Allure Report (victoria198611.github.io in Bing)
